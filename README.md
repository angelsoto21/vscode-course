...
# comandos para la barra lateral izquierda
...
# Para abrir un archivo del sistema
Ctrl + P
...
# Crear copias hacia abajo 
alt + shift + flecha para abajo o para arriba.

# Crear cursores hacia arriba o abajo.
Ctrl + Alt + flecha para abajo o para arriba.

# Para seleccionar una palabra con multiples cursores con posiciones especificas
Mantener Alt + doble click o Alt + Seleccionar todo lo que quieras.

# Para crear multiples cursores usando el next find match
Ctrl + D

# Para buscar definiciones en un archivo (funciones, variables, etc..)
Ctrl + shift + P y Poner el arroba @

# Para ir a una linea
Ctrl + Shift + P y Poner los dos puntos :

# Para remplazar clases, variables,etc y que se modifique en todos los lugares donde los usamos
f2 en la clase y cambiar el nombre.

# Snippets basicos
para crear lanzamos Ctrl + shift + P y escribimos user snippets

# Para abrir los developments tools de google chrome dev
ctrl + shift + I
